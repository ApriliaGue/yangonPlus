...
<section class="relative min-h-80 bg-[#EFD64D] flex flex-col items-center justify-center text-center overflow-hidden">
    ...
    <div class="relative max-w-4xl space-y-4">
        <h1 class="text-4xl text-[#1F0730] font-semibold">Visa Assistance</h1>
...
<div class="layout1 space-y-20 text-black">
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-4 gap-6 font-normal text-[#1F0730]">
            <div>
                <label class="text-xs text-[#3E465F]">Country <span class="text-[#D23118]">*</span></label>
                <input type="text" placeholder="Country you are applying for" class="w-full bg-white rounded-lg p-3 mt-1 text-base shadow-sm">
            </div>
            <div class="relative">
                <label class="text-xs text-[#3E465F]">Visa Type <span class="text-[#D23118]">*</span></label>
                <input type="text" placeholder="Select visa type" class="w-full bg-white rounded-lg p-3 mt-1 text-base shadow-sm">
    ...
    <!-- Do & Don't -->
    <div class="grid grid-cols-2 gap-6 font-normal text-base text-black leading-relaxed">
