<div class="w-full max-w-7xl mx-auto p-4 space-y-6">
    <div class="flex items-center space-x-6 text-base font-medium text-black">
        <label class="flex items-center space-x-2 cursor-pointer">
            <input type="radio" name="trip-type" id="one-way" class="w-5 h-5 accent-[#1F0730]" checked>
            <span>One Way</span>
        </label>
        <label class="flex items-center space-x-2 cursor-pointer">
            <input type="radio" name="trip-type" id="round-trip" class="w-5 h-5 accent-[#1F0730]">
            <span>Round trip</span>
        </label>
    </div>

    <div class="flex flex-col md:flex-row md:flex-wrap xl:flex-nowrap items-end gap-y-5 gap-x-4">

        <div class="w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-0.75rem)] xl:w-1/5 min-w-[140px]">
            <label for="flight-name" class="text-xs font-normal text-[#3E465F]">Flight name</label>
            <input type="text" id="flight-name" placeholder="MAI/MNA" class="w-full bg-white rounded-lg px-4 py-3 mt-1 text-base font-normal text-[#1F0730] shadow-sm border border-gray-100 focus:outline-none focus:ring-2 focus:ring-[#EBEDA4]">
        </div>

        <div class="w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-0.75rem)] xl:w-1/5 relative">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="departure-city" placeholder="Departure city" class="w-full bg-white rounded-lg px-10 py-3 text-base font-normal text-[#1F0730] shadow-sm border border-gray-100 focus:outline-none focus:ring-2 focus:ring-[#EBEDA4]">

                <button type="button" aria-label="Swap Locations" class="absolute right-4 xl:-right-[19px] top-1/2 -translate-y-1/2 xl:translate-x-0 z-20 transition-transform active:scale-95 shadow-md rounded-full">
        ...
        <div class="w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-0.75rem)] xl:w-1/5">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="arrival-city" placeholder="Arrival city" class="w-full bg-white rounded-lg px-10 py-3 text-base font-normal text-[#1F0730] shadow-sm border border-gray-100 focus:outline-none focus:ring-2 focus:ring-[#EBEDA4]">
            </div>
        </div>

        <div class="w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(50%-0.5rem)] xl:w-1/5">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="departure-date" placeholder="Select date" class="w-full bg-white rounded-lg px-10 py-3 text-base font-normal text-[#1F0730] shadow-sm border border-gray-100 focus:outline-none focus:ring-2 focus:ring-[#EBEDA4]">
                <button type="button" aria-label="Swap Locations" class="absolute right-4 xl:-right-[19px] top-1/2 -translate-y-1/2 xl:translate-x-0 z-20 transition-transform active:scale-95 shadow-md rounded-full">
                    <svg width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="35" height="36" rx="17.3144" fill="#EBEDA4" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11 21.5C11 21.7761 11.2239 22 11.5 22H23.2929L20.1464 25.1464C19.9512 25.3417 19.9512 25.6583 20.1464 25.8536C20.3417 26.0488 20.6583 26.0488 20.8536 25.8536L24.8536 21.8536C25.0488 21.6583 25.0488 21.3417 24.8536 21.1464L20.8536 17.1464C20.6583 16.9512 20.3417 16.9512 20.1464 17.1464C19.9512 17.3417 19.9512 17.6583 20.1464 17.8536L23.2929 21H11.5C11.2239 21 11 21.2239 11 21.5Z" fill="black" />
        ...
        <div class="w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(50%-0.5rem)] xl:w-1/5">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="return-date" placeholder="Select date" class="w-full bg-white rounded-lg px-10 py-3 text-base font-normal text-[#1F0730] shadow-sm border border-gray-100 focus:outline-none focus:ring-2 focus:ring-[#EBEDA4]">
            </div>
        </div>
