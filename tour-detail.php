...
<div class="layout1 space-y-20">
    <div class="flex justify-between space-x-10">
        <!-- Left -->
        <div class="w-full text-[#1F0730] space-y-10">
            <!-- Breadcrumb -->
            <div class=space-y-4>
    ...
    <div class=space-y-6>
        <div class="flex justify-between">
            <h4 class="text-4xl font-semibold text-black my-auto">Other travel tours</h4>
            <div class="flex justify-end gap-3">
                <button type="button" class="flex h-14 w-14 items-center justify-center rounded-sm bg-[#EEEEEE] opacity-40">
                ...
                <button type="button" class="flex h-14 w-14 items-center justify-center rounded-sm bg-[#EEEEEE]">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="grid grid-cols-4 gap-8">
            <?php for ($i = 0; $i < 4; $i++): ?>
                <div class="card bg-white hover:shadow-lg rounded-2xl overflow-hidden transition-shadow duration-300">
                    <img src="assets/img/tour4.jpg" alt="" class="w-full h-80 object-cover rounded-t-2xl">
                    <div class="p-4">
