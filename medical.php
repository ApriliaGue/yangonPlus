...
<section class="relative min-h-80 bg-[#EFD64D] flex flex-col items-center justify-center text-center overflow-hidden">
    ...
    <div class="relative max-w-4xl space-y-4">
        <h1 class="text-4xl text-[#1F0730] font-semibold">Medical Treatment (Overseas Hospitals)</h1>
        <p class="text-lg text-[#3E465F] font-medium">
            We help arrange medical travel for treatment at accredited overseas hospitals. Our services include hospital appointment booking, interpreter support, and travel coordination.
        </p>
    </div>
</section>
    ...
    <div class="grid grid-cols-3 gap-8">
        <?php for ($i = 0; $i < 6; $i++): ?>
            <div class="card bg-white hover:shadow-lg rounded-2xl overflow-hidden transition-shadow duration-300">
                <img src="assets/img/hospital.png" alt="" class="w-full h-80 object-cover rounded-t-2xl">
                <div class="p-4 space-y-2">
                    <button class="px-3 py-2 bg-[#EFD64D4D] rounded-full">Singapore</button>
                    <h5 class="text-xl font-semibold text-[#1F0730]">Mount Elizabeth Hospital</h5>
                </div>
            </div>
        <?php endfor; ?>
    </div>
