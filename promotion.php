<div class="py-10 md:py-18 bg-[#F8F8F5] text-[#3E465F]">
    <?php include 'banner.php' ?>
    <!-- Our Services -->
    <div class="container-default pt-10 md:pt-18 text-center">
        <h4 class="text-black text-2xl md:text-4xl font-semibold leading-tight">Our Services</h4>
        <p class="text-base md:text-lg text-[#626A82] font-medium py-3">A comprehensive range of travel and lifestyle services tailored to your needs.</p>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:mt-5">
            <!-- Tour Packages -->
            <a href="tour.php" class="block">
                <div class="flex text-left gap-4 md:gap-6 p-4 md:p-6 hover:bg-white hover:shadow-lg rounded-2xl h-full transition-all duration-200">
                    ...
                    <div class="leading-relaxed">
                        <h5 class="text-[#1F0730] text-lg md:text-xl font-semibold">Tour Packages</h5>
                        <p class="text-sm md:text-base font-normal md:mt-2">Our guides are locals who know the hidden gems, stories, and secret spots you won't find in guidebooks.</p>
                    </div>
                </div>
            </a>
            <!-- Flight Booking -->
            <a href="flightbooking.php" class="block">
                <div class="flex text-left gap-4 md:gap-6 p-4 md:p-6 hover:bg-white hover:shadow-lg rounded-2xl h-full transition-all duration-200">
                    ...
                    <div class="leading-relaxed">
                        <h5 class="text-[#1F0730] text-lg md:text-xl font-semibold">Flight Booking</h5>
                        <p class="text-sm md:text-base font-normal md:mt-2">Our guides are locals who know the hidden gems, stories, and secret spots you won't find in guidebooks.</p>
                    </div>
                </div>
            </a>
            ...
            <a href="golftour.php" class="block">
                <div class="flex text-left gap-4 md:gap-6 p-4 md:p-6 hover:bg-white hover:shadow-lg rounded-2xl h-full transition-all duration-200">
                    ...
                    <div class="leading-relaxed">
                        <h5 class="text-[#1F0730] text-lg md:text-xl font-semibold">Golf Tour</h5>
                        <p class="text-sm md:text-base font-normal md:mt-2">Our guides are locals who know the hidden gems, stories, and secret spots you won't find in guidebooks.</p>
                    </div>
                </div>
            </a>
            ...
            <a href="visa.php" class="block">
                <div class="flex text-left gap-4 md:gap-6 p-4 md:p-6 hover:bg-white hover:shadow-lg rounded-2xl h-full transition-all duration-200">
                    ...
                    <div class="leading-relaxed">
                        <h5 class="text-[#1F0730] text-lg md:text-xl font-semibold">Visa Assistance</h5>
                        <p class="text-sm md:text-base font-normal md:mt-2">Our guides are locals who know the hidden gems, stories, and secret spots you won't find in guidebooks.</p>
                    </div>
                </div>
            </a>
