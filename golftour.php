                            ...
                            <div class="card bg-white hover:shadow-lg rounded-2xl overflow-hidden transition-shadow duration-300">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center gap-3 text-center text-sm md:text-base font-medium text-[#1F0730]">
                                        <a href="golftour-inquiry.php" class="w-1/2 border border-[#EFD64D] hover:bg-[#EFD64D] py-2.5 rounded-full transition duration-300">Inquiry</a>
                                        <a href="golftour-detail.php" class="w-1/2 border border-[#EFD64D] bg-[#EFD64D] hover:bg-[#EBE359] py-2.5 rounded-full transition duration-300">Details</a>
                                    </div>
                                </div>
                            </div>
                        <?php endfor; ?>
