...
<section class="relative min-h-80 bg-[#EFD64D] flex flex-col items-center justify-center text-center overflow-hidden">
    ...
    <div class="relative max-w-4xl space-y-4">
        <h1 class="text-4xl text-[#1F0730] font-semibold">Flight Booking</h1>
    ...
    <div class="flex bg-white rounded-xl px-3 py-2 space-x-4 mt-4">
...
<div class="layout1 space-y-20 text-black">
    <div class="space-y-6">
        ...
        <!-- Card -->
        <h4 class="text-4xl font-semibold">Our available airlines routes</h4>
        <div class="space-y-4">
            <?php for ($i = 0; $i < 6; $i++): ?>
                <div class="flex min-h-36 bg-white space-x-4 border border-[#2E31924D] rounded-lg">
                    <img src="assets/img/air1.png" alt="" class="w-48 h-36 object-contain rounded-tl-lg rounded-bl-lg">
                    <div class="w-xl my-auto space-y-1">
                        <h5 class="text-xl font-semibold">Myanmar National Airline</h5>
                        <div class="flex text-base font-normal gap-2">
                            <p class="my-auto">Yangon</p>
                            <svg class="w-9 h-9 my-auto" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="my-auto">Mandalay</p>
                        </div>
                    </div>
                    <div class="flex text-base font-normal gap-2 bg-[#EBEDA4] px-6 rounded-full my-auto">
                        <p class="my-auto">20 Apr</p>
                        <svg class="w-9 h-9 my-auto" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11 21.5C11 21.7761 11.2239 22 11.5 22H23.2929L20.1464 25.1464C19.9512 25.3417 19.9512 25.6583 20.1464 25.8536C20.3417 26.0488 20.6583 26.0488 20.8536 25.8536L24.8536 21.8536C25.0488 21.6583 25.0488 21.3417 24.8536 21.1464L20.8536 17.1464C20.6583 16.9512 20.3417 16.9512 20.1464 17.1464C19.9512 17.3417 19.9512 17.6583 20.1464 17.8536L23.2929 21H11.5C11.2239 21 11 21.2239 11 21.5Z" fill="black" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M25 14.5C25 14.7761 24.7761 15 24.5 15H12.7071L15.8536 18.1464C16.0488 18.3417 16.0488 18.6583 15.8536 18.8536C15.6583 19.0488 15.3417 19.0488 15.1464 18.8536L11.1464 14.8536C10.9512 14.6583 10.9512 14.3417 11.1464 14.1464L15.1464 10.1464C15.3417 9.95118 15.6583 9.95118 15.8536 10.1464C16.0488 10.3417 16.0488 10.6583 15.8536 10.8536L12.7071 14H24.5C24.7761 14 25 14.2239 25 14.5Z" fill="black" />
                        </svg>
                        <p class="my-auto">30 May</p>
                    </div>
                    <a href="flightbooking-detail.php" class="flex border-l border-[#2E31924D] ml-auto p-10">
                        <span class="text-[#1F0730] text-base text-center font-medium my-auto">Inquiry</span>
