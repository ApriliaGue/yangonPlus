...
<img src="assets/img/golf2.png" alt="" class="w-full h-80 object-cover">
<div class="layout1 space-y-20">
    <div class="flex justify-between space-x-10">
        <!-- Left -->
        <div class="w-full text-[#1F0730] space-y-10">
            <h4 class="text-4xl font-semibold">SG-Singapore-SG-Sentosa Golf Club-7 Days</h4>
            <div class="space-y-6">
                ...
                <?php for ($i = 0; $i < 7; $i++): ?>
                    <div class="flex gap-4">
                        ...
                        <div class="space-y-2">
                            <p class="text-lg font-medium">Golf at Sky Lake Resort</p>
                            <p class="text-base font-normal text-[#3E465F]">
                                After breakfast, head to Sky Lake Resort for an exhilarating round of golf. Experience the breathtaking views of the surrounding mountains and lakes while playing on this renowned course. Return to Hanoi for an evening of leisure.
                            </p>
                        </div>
                    </div>
                <?php endfor ?>
        ...
        <div class="space-y-6 w-4xl">
            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                ...
                <ul class="list-disc list-inside">
                    <li>Green fees & caddie fees for 3 rounds</li>
                    <li>Accommodation in selected hotel category with daily breakfast</li>
                    <li>1-night Cruise (meals included)</li>
                    <li>Private and golf transfers</li>
                    <li>Myanmar-speaking guide during transfers</li>
                </ul>
                </p>
            </div>
            <div class="bg-white rounded-lg shadow-sm p-4">
                ...
                <ul class="list-disc list-inside">
                    ...
                    <li>Personal expenses & tips for drivers</li>
                </ul>
                </p>
            </div>
            <div class="bg-[#EFD64D1A] rounded-lg shadow-md p-4">
                ...
                <a href="golftour-inquiry.php" class="bg-[#2E3192] hover:bg-[#EBE359] text-[#FFFFFF] text-sm font-medium px-4 py-3 gap-1 rounded-full flex items-center justify-center transition duration-300 ease-out">
