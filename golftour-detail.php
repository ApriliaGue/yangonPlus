...
<img src="assets/img/golf2.png" alt="" class="w-full h-48 md:h-80 object-cover">
<div class="bg-[#F8F8F5]">
    <div class="container-default py-10 md:py-18 space-y-10 md:space-y-20">
        <div class="flex flex-col md:flex-row justify-between gap-4 md:gap-6">
            ...
            <div class="w-full md:w-2/3 text-[#1F0730] space-y-5 md:space-y-10">
                <h4 class="text-2xl md:text-4xl font-semibold">SG-Singapore-SG-Sentosa Golf Club-7 Days</h4>
                <div class="space-y-6">
                    ...
                    <?php for ($i = 0; $i < 6; $i++): ?>
                        <div class="swiper-slide h-auto">
                            <div class="bg-white hover:shadow-md rounded-2xl overflow-hidden transition-shadow duration-300 h-full">
                                <img src="assets/img/golf5.png" alt="" class="aspect-square object-cover w-full rounded-t-2xl">
                                <div class="p-4">
