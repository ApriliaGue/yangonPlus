<div class="relative h-auto bg-[var(--Base-Gray,#3E465F)]">
    ...
    <div class="relative z-10 flex flex-col justify-start container-default">
        <div class="flex items-start justify-between flex-col lg:flex-row text-white py-10 md:py-18 gap-4 md:gap-6">
            <h4 class="text-2xl md:text-4xl font-semibold leading-tight lg:leading-relaxed w-full lg:w-[25%]">Our Popular<br class="hidden lg:block"> Golf Tours</h4>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 w-full lg:w-[75%]">
                <?php for ($i = 0; $i < 3; $i++): ?>
                    <a href="golftour-detail.php" class="block w-full">
                        <div class="relative group overflow-hidden rounded-2xl">
                            <img src="assets/img/golf5.png" alt="" class="w-full min-h-72 lg:min-h-110 object-cover rounded-2xl">
                            <div class="flex absolute bottom-5 left-5 right-5 justify-between items-center gap-1 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-out">
                                <h5 class="text-lg md:text-xl font-semibold my-auto truncate">TH-Pattaya-Black Mountain Golf Club-6days</h5>
                                <svg class="shrink-0 w-6 h-6 md:w-9 md:h-9" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
