        ...
        <div class="space-y-10">
            ...
            <div class="space-y-4">
                <div class="flex flex-wrap w-fit text-base font-normal gap-2 border border-[#2E31921A] p-3 rounded-full">
                    ...
                    <a href="golftour.php" class="text-[#2E3192]">Golf tours</a>
                    <svg class="w-4 h-4 my-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="m9 18 6-6-6-6" />
                    </svg>
                    <a href="golftour-detail.php" class="text-[#151567]">SG-Singapore-SG-Sentosa Golf Club-7 Days</a>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between gap-4 md:gap-6">
                <!-- Left -->
                <form action="" method="$_POST" class="w-full md:w-2/3 space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 font-normal text-[#1F0730] sm:px-6 md:pl-6 md:pr-0">
                        <div>
                ...
                <!-- Right -->
                <div class="space-y-4 md:space-y-6 w-full md:w-1/3 mt-7">
