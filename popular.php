<section id="popular-tours" class="scroll-mt-12 py-10 md:py-18 bg-[#F8F8F5]">
    <div class="container-default text-[#1F0730]">
        <div class="flex flex-col md:flex-row md:items-end md:justify-between pb-6 gap-4">
            <div class="space-y-2 max-w-2xl">
                <h4 class="text-2xl md:text-4xl font-bold tracking-tight">Most Popular Tours & Packages</h4>
            ...
            <div class="flex">
                <a href="tour.php" class="hover:bg-[#EBE359] text-sm md:text-base font-medium px-4 py-3 gap-1 rounded-full inline-flex items-center transition duration-300 ease-out whitespace-nowrap">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            <?php for ($i = 0; $i < 3; $i++): ?>
                <div class="group bg-white hover:shadow-xl rounded-2xl overflow-hidden transition-all duration-300 flex flex-col h-full">
                        ...
                        <div>
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs font-bold leading-relaxed">4 Days/ 3 Nights</p>
                                </div>
                            </div>
                            <hr class="my-4 border-[#2E319280] opacity-20">
                            <h5 class="text-lg md:text-xl font-semibold text-[#1F0730] line-clamp-2 mb-2 group-hover:text-[#2E3192] transition-colors duration-200">
